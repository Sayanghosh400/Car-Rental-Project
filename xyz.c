...
struct info
{
    ...
    char p[2],pickup[30],address[50],city[50],state[50],name[50];
};
     ...
     while (1)
    {
        ...
        switch (car)
        {
            ...
            case 1:
               ...
               printf("Booking is confirmed:\n Name : %s\n Car : Suzuki\n Rent : 15000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d \n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n",suzuki.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,suzuki.day,suzuki.month,suzuki.year,suzuki.hour,suzuki.minute,suzuki.p[0],suzuki.p[1],suzuki.address,suzuki.city,suzuki.state,suzuki.pincode);
               suzuki.crno--;
               fprintf(save,"Booking is confirmed:\n Name : %s\n Car : Suzuki\n Rent : 15000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d \n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n\n",suzuki.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,suzuki.day,suzuki.month,suzuki.year,suzuki.hour,suzuki.minute,suzuki.p[0],suzuki.p[1],suzuki.address,suzuki.city,suzuki.state,suzuki.pincode);
               fclose(save);
                break;
            ...
            case 2:
                ...
                printf("Booking is confirmed:\n Name : %s\n Car : Audi\n Rent : 10000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d\n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n",audi.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,audi.day,audi.month,audi.year,audi.hour,audi.minute,audi.p[0],audi.p[1],audi.address,audi.city,audi.state,audi.pincode);
                audi.crno--;
                fprintf(save,"Booking is confirmed:\n Name : %s\n Car : Audi\n Rent : 10000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d\n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n\n",audi.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,audi.day,audi.month,audi.year,audi.hour,audi.minute,audi.p[0],audi.p[1],audi.address,audi.city,audi.state,audi.pincode);
                fclose(save);
                break;
            ...
            case 3:
               ...
               printf("You have successfully booked Skoda\nThe rent for this car is 25000 rs/km\n");
                ...
                printf("Booking is confirmed:\n Name : %s\n Car : Skoda\n Rent : 25000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d \n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n",skoda.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,skoda.day,skoda.month,skoda.year,skoda.hour,skoda.minute,skoda.p[0],skoda.p[1],skoda.address,skoda.city,skoda.state,skoda.pincode);
                skoda.crno--;
                fprintf(save,"Booking is confirmed:\n Name : %s\n Car : Skoda\n Rent : 25000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d \n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n\n",skoda.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,skoda.day,skoda.month,skoda.year,skoda.hour,skoda.minute,skoda.p[0],skoda.p[1],skoda.address,skoda.city,skoda.state,skoda.pincode);
                fclose(save);
                break;
            ...
            case 4:
                ...
                printf("Booking is confirmed:\n Name : %s\n Car : BMW\n Rent : 30000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d \n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n",bmw.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,bmw.day,bmw.month,bmw.year,bmw.hour,bmw.minute,bmw.p[0],bmw.p[1],bmw.address,bmw.city,bmw.state,bmw.pincode);
                bmw.crno--;
                fprintf(save,"Booking is confirmed:\n Name : %s\n Car : BMW\n Rent : 30000 rs/km\n Bokking Date : %02d-%02d-%4d\n Pickup Date : %02d-%02d-%4d \n Pickup Time : %02d:%02d %c%c\n Pickup Address : %s\n Pickup City : %s\n Pickup State : %s\n Pincode : %d\n\n",bmw.name,tm.tm_mday,tm.tm_mon+1,tm.tm_year+1900,bmw.day,bmw.month,bmw.year,bmw.hour,bmw.minute,bmw.p[0],bmw.p[1],bmw.address,bmw.city,bmw.state,bmw.pincode);
                fclose(save);
                break;
